            ...
            <div>
                <div class="w-full flex flex-col md:flex-row items-center justify-between py-4 my-2">
                    <div class="w-full ml-3">
                        <create-question-descriptive v-if="type === 'descriptive'" :index="index" :question="question"/>
                        <create-question-test v-else :index="index" :question="question"/>
                    </div>
                    <div
...
import CreateQuestionDescriptive from "./DescriptiveQuiz/EditQuestion.vue";
import CreateQuestionTest from "./TestQuiz/EditQuestion.vue";
//Pinia
...
/**************** Const ****************/
// Index
const index = props.question.id ? props.question.id : 'N' + (new Date().getTime());
/**************** Pinia ****************/
const EditQuiz = useEditQuiz();
// Create pinia states
const {content} = storeToRefs(EditQuiz);
/**************** Properties ****************/
// Show Top,In,Bottom
